...
Components allow us to compartmentize sections of reuseable code to save time and potential error.

### Git Set up

* [x] Fork the project into your GitHub user account
* [x] Clone the forked project into a directory on your machine
* [x] Create a pull request before you start working on the project rexuirements.  You will continuously push your updates throughout the project.
